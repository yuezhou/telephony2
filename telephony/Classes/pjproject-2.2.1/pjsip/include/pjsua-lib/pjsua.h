...
/**
 * Structure to be passed on SLA callback.
 */
typedef struct pjsua_sla_info
{
...
/**
 * Structure to be passed on BLF callback.
 */
typedef struct pjsua_blf_info
{
    pjsip_evsub     *evsub;     /**< Event subscription session, for reference. */
    pjsip_rx_data   *rdata;     /**< The received NOTIFY request.       */
    int             line;
...
typedef struct pjsua_callback
{
    ...
    void (*on_sla_info)(pjsua_acc_id acc_id, pjsua_sla_info *sla_info);
...
/**
 * Max # of shared lines always be real number plus 1
 */
#ifndef PJSUA_MAX_NUMBER_OF_SHARED_LINES
#   define PJSUA_MAX_NUMBER_OF_SHARED_LINES             24 + 1
#endif

/**
 * Max # of blf remote devices always be real number plus 1
 */
#ifndef PJSUA_MAX_NUMBER_OF_BLF_DEVICES
#   define PJSUA_MAX_NUMBER_OF_BLF_DEVICES              72 + 1
#endif

#ifndef PJSUA_SLA_SUBSCRIPTION_TYPE_SLA
#   define PJSUA_SLA_SUBSCRIPTION_TYPE_SLA              0
#endif
#ifndef PJSUA_SLA_SUBSCRIPTION_TYPE_BLF
#   define PJSUA_SLA_SUBSCRIPTION_TYPE_BLF              1
#endif
...
typedef struct pjsua_acc_config
{
    ...
    /**
     * Subscribe to dialog events for SLA.
     *
     * See also \a enable_unsolicited_sla field on #pjsua_config.
     *
     * Default: no
     */
    pj_bool_t       sla_line_enabled[PJSUA_MAX_NUMBER_OF_SHARED_LINES];
    pj_str_t        line[PJSUA_MAX_NUMBER_OF_SHARED_LINES];
    
    pj_bool_t       blf_enabled[PJSUA_MAX_NUMBER_OF_BLF_DEVICES];
    pj_str_t        blf[PJSUA_MAX_NUMBER_OF_BLF_DEVICES]; // remote uri for blf subscription
